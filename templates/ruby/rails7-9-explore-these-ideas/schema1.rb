table :account_history_data, force: :cascade do
  ...
  table :action_logs, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :activities, force: :cascade do
    column :user_id                                            , type: :integer
    column :tenant_id                                            , type: :integer
  ...
  table :addresses, force: :cascade do
    column :city
    column :country
    column :deleted          ,                         default: false
    column :manualchange
  ...
  table :adjustments, force: :cascade do
    column :total
    column :invoice_id                                           , type: :integer
    column :company_id                                           , type: :integer
    column :tenant_id                                            , type: :integer
  ...
  table :affiliations, force: :cascade do
    column :user_id                                           , type: :integer
    column :tenant_id                                           , type: :integer
    column :primary
  end
  ...
  table :api_logs, force: :cascade do
    column :url
  ...
  table :background_job_results, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :user_id                                            , type: :integer
    column :job_hash
    column :job_type
  ...
  table :background_jobs, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :user_id                                            , type: :integer
    column :job_type
    column :name
  ...
  table :backups, force: :cascade do
  ...
  table :badges_sashes, force: :cascade do
  ...
  table :bookmarks, force: :cascade do
    column :user_id                                            , type: :integer
    column :context_id                                           , type: :integer
    column :context_type
    column :created_at          ,   null: false
  ...
  table :budget_months, force: :cascade do
  ...
  table :budgets, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :calendar_entries, force: :cascade do
  ...
  table :calendar_entry_deletions, force: :cascade do
    column :user_id                                           , type: :integer
  ...
  table :calendars, force: :cascade do
  ...
  table :campaign_calendar_entries, force: :cascade do
    column :campaign_id                                            , type: :integer
    column :tenant_id                                            , type: :integer
    column :user_id                                            , type: :integer
  ...
  table :campaign_counts, force: :cascade do
    column :tenant_id                                           , type: :integer
    column :campaign_id                                           , type: :integer
    column :total_count                                           , type: :integer
  end

  table :campaign_exclusions, force: :cascade do
    column :campaign_id                                           , type: :integer
    column :contact_id                                            , type: :integer
  end
  ...
  table :campaign_groups, force: :cascade do
    column :name
  ...
  table :campaign_messages, force: :cascade do
    column :campaign_id                                            , type: :integer
    column :contact_id                                           , type: :integer
    column :opened
    column :sent
  ...
  table :campaign_messages_trackers, id: false, force: :cascade do
    column :campaign_message_id                                           , type: :integer
    column :tracker_id                                            , type: :integer
  end
  ...
  table :campaigns, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :name                                       , type: :text
    column :description                                        , type: :text
    column :global
  ...
  table :campaigns_contact_lists, id: false, force: :cascade do
    column :campaign_id                                           , type: :integer
  ...
  table :cash_drawers, force: :cascade do
  ...
  table :clearbit_quota, force: :cascade do
    column :klass
  ...
  table :comments, force: :cascade do
  ...
  table :companies, force: :cascade do
  ...
  table :contact_groups, force: :cascade do
  ...
  table :contact_groups_contacts, id: false, force: :cascade do
  ...
  table :contact_list_counts, force: :cascade do
    column :tenant_id                                           , type: :integer
    column :contact_list_id                                           , type: :integer
    column :total_count                                           , type: :integer
  ...
  table :contact_list_exclusions, force: :cascade do
    column :contact_list_id                                           , type: :integer
    column :contact_id                                            , type: :integer
    column :tenant_id                                           , type: :integer
  end
  ...
  table :contact_list_rules, force: :cascade do
    column :contact_list_id                                           , type: :integer
  ...
  table :contact_lists, force: :cascade do
    column :name                                       , type: :text
    column :created_at          ,       type: :datetime          ,                     null: false
    column :updated_at          ,       type: :datetime          ,                     null: false
    column :icon
  ...
  table :contact_lists_contacts, id: false, force: :cascade do
    column :contact_id                                            , type: :integer
    column :contact_list_id                                           , type: :integer
  end
  ...
  table :contacts, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :company_id                                           , type: :integer
    column :printsmith_id                                            , type: :integer
    column :first_name          ,                      limit: 255
  ...
  add_index "contacts"          , ["tenant_id"]          , name: "contacts_tenant_id_where_contactable"          ,e: "((NOT temp) AND (NOT deleted) AND (NOT marketing_do_not_mail) AND (NOT marketing_unsubscribe) AND (NOT on_suppression_list))"          , using: :btree
  ...
  table :countries, force: :cascade do
    column :name
  end

  table :countries_enterprises, id: false, force: :cascade do
  ...
  table :country_states, force: :cascade do
  ...
  table :country_states_holidays, id: false, force: :cascade do
  ...
  table :deployments, force: :cascade do
    column :name                                       , type: :text
    column :os                                       , type: :text
    column :checksum                                       , type: :text
  ...
  table :email_aliases, force: :cascade do
    column :user_id                                           , type: :integer
    column :email
  end

  table :email_credentials, force: :cascade do
  ...
  table :email_deliveries, force: :cascade do
    column :message          , default: {}          , null: false                                , type: :jsonb
  end

  table :email_message_activities, force: :cascade do
  ...
  table :email_soft_bounces, force: :cascade do
    column :tenant_id                                           , type: :integer
  ...
  table :email_statuses, force: :cascade do
    column :email_address
    column :status                                           , type: :integer
  ...
  table :email_tags, force: :cascade do
    column :user_id                                            , type: :integer
    column :tenant_id                                            , type: :integer
    column :label_id
    column :name
  ...
  table :email_tags_emails, id: false, force: :cascade do
  ...
  table :email_template_categories, force: :cascade do
    column :email_template_id                                           , type: :integer
    column :category                                            , type: :integer
  end

  table :email_template_fields, force: :cascade do
    column :email_template_id                                           , type: :integer
    column :name                                                      , type: :text
    column :required          ,          default: false
  end

  table :email_template_values, force: :cascade do
  ...
  table :email_templates, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :user_id                                            , type: :integer
    column :global          ,                                                  default: false
    column :name          ,                          limit: 255
  ...
  table :email_validations, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :enterprise_id                                            , type: :integer
    column :contact_id                                           , type: :integer
    column :address
  ...
  table :emails_trackers, id: false, force: :cascade do
    column :email_id                                            , type: :integer
    column :tracker_id                                            , type: :integer
  end
  ...
  table :enterprise_salestargets, force: :cascade do
    column :prospect_status_id                                            , type: :integer
    column :enterprise_id                                           , type: :integer
  ...
  table :enterprise_togglefields, force: :cascade do
    column :enterprise_id                                           , type: :integer
    column :field          ,         limit: 40
    column :read_only          ,                default: false
  end

  table :enterprises, force: :cascade do
    column :name
    column :created_at          ,                                                  null: false
    column :updated_at          ,                                                  null: false
  ...
  table :estimate_elements, force: :cascade do
    column :estimate_id                                            , type: :integer
    column :element_id                                           , type: :integer
    column :element_type          , limit: 255
    column :created_at          ,               type: :datetime
  ...
  table :estimates, force: :cascade do
    column :name                                       , type: :text
    column :tenant_id                                            , type: :integer
    column :created_at          ,                           type: :datetime
    column :updated_at          ,                           type: :datetime
  ...
  table :etl_settings, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :event_stats, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :event_type
    column :data                                              , type: :jsonb
    column :duration
  ...
  table :exclusions, force: :cascade do
    column :user_id                                            , type: :integer
    column :context_id                                           , type: :integer
    column :context_type
    column :created_at          ,   null: false
  ...
  table :filter_defaults, force: :cascade do
    column :user_id                                           , type: :integer
    column :context_id                                            , type: :integer
    column :context_type
    column :section
  ...
  table :groups_tenants, id: false, force: :cascade do
    column :tenant_id          , null: false                                            , type: :integer
  ...
  table :hidden_email_templates, force: :cascade do
    column :email_template_id                                           , type: :integer
    column :tenant_id                                           , type: :integer
  end

  table :hidden_holidays, force: :cascade do
    column :holiday_id                                            , type: :integer
    column :tenant_id                                           , type: :integer
  end

  table :hidden_lead_types, force: :cascade do
    column :lead_type_id                                            , type: :integer
    column :tenant_id                                           , type: :integer
  end

  table :hidden_task_types, force: :cascade do
    column :task_type_id                                            , type: :integer
    column :tenant_id                                           , type: :integer
  end

  table :holiday_dates, force: :cascade do
    column :holiday_id                                            , type: :integer
  ...
  table :holidays, force: :cascade do
  ...
  table :identities, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :inquiries, force: :cascade do
    column :from_name
    column :from_email
    column :description                                        , type: :text
    column :user_id                                            , type: :integer
  ...
  table :inquiry_attachments, force: :cascade do
    column :inquiry_id                                            , type: :integer
    column :name
    column :url
  end
  ...
  table :interest_categories, force: :cascade do
    column :name
    column :enterprise_id                                           , type: :integer
  ...
  table :interest_contexts, force: :cascade do
  ...
  table :interests, force: :cascade do
    column :name
    column :user_id                                           , type: :integer
  ...
  table :invoice_elements, force: :cascade do
    column :invoice_id                                           , type: :integer
    column :element_id                                           , type: :integer
    column :tenant_id                                            , type: :integer
    column :element_type
  ...
  table :invoices, force: :cascade do
    column :name                                       , type: :text
    column :grand_total          ,                            type: :decimal
    column :printsmith_id          ,              limit: 8                                           , type: :integer
    column :tenant_id                                            , type: :integer
  ...
  table :job_stats, force: :cascade do
    column :job_name
  ...
  table :lead_types, force: :cascade do
    column :name
    column :description
    column :enterprise_id                                           , type: :integer
  ...
  table :locations, force: :cascade do
    column :name
    column :tenant_id                                            , type: :integer
    column :created_at          ,  type: :datetime          ,                 null: false
    column :updated_at          ,  type: :datetime          ,                 null: false
  ...
  table :marketing_groups, force: :cascade do
    column :name
  ...
  table :meeting_attendees, force: :cascade do
    column :meeting_id                                            , type: :integer
    column :user_id                                           , type: :integer
    column :contact_id                                            , type: :integer
  ...
  table :meetings, force: :cascade do
    column :user_id                                            , type: :integer
    column :tenant_id                                            , type: :integer
    column :context_id                                           , type: :integer
    column :context_type
  ...
  table :next_activities, force: :cascade do
    column :scheduled
    column :contact_id                                           , type: :integer
    column :context_id                                           , type: :integer
    column :context_type
  ...
  table :original_users, force: :cascade do
    column :user_id                                            , type: :integer
  ...
  table :pending_attachments, force: :cascade do
    column :uuid
    column :file_name
    column :path
    column :complete
  ...
  table :phone_calls, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :portal_comments, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :user_id                                            , type: :integer
    column :context_type
    column :context_id                                           , type: :integer
  ...
  table :production_locations, force: :cascade do
    column :name          ,              limit: 255
    column :tenant_id                                            , type: :integer
    column :printsmith_id                                            , type: :integer
    column :created_at          ,                    type: :datetime
  ...
  table :prospect_status_item_contacts, force: :cascade do
    column :prospect_status_item_id                                            , type: :integer
    column :contact_id                                           , type: :integer
    column :tenant_id                                            , type: :integer
    column :start_date
  ...
  table :prospect_status_items, force: :cascade do
    column :name
    column :prospect_status_id                                            , type: :integer
    column :lead_type_id                                            , type: :integer
    column :tenant_id                                           , type: :integer
  ...
  table :prospect_status_versions, force: :cascade do
    column :lead_type_id                                            , type: :integer
  ...
  table :prospect_statuses, force: :cascade do
    column :name
    column :user_id                                            , type: :integer
    column :enterprise_id          ,                          null: false                                            , type: :integer
    column :created_at          ,                             null: false
  ...
  table :read_marks, force: :cascade do
  ...
  table :region_configs, force: :cascade do
    column :option                                       , type: :text
    column :value                                        , type: :text
  end

  table :report_rows, force: :cascade do
  ...
  table :reports, force: :cascade do
    column :name
    column :tenant_id                                           , type: :integer
    column :user_id                                           , type: :integer
    column :global
  ...
  table :sales_base_taxes, force: :cascade do
    column :tenant_id                                            , type: :integer
  ...
  table :sales_categories, force: :cascade do
    column :glaccount
    column :interest
    column :deleted          ,                     default: false
    column :name
  ...
  table :sales_rep_updates, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :sales_rep_id                                           , type: :integer
    column :created_at
    column :updated_at
  ...
  table :sales_reps, force: :cascade do
    column :name          ,                limit: 255
    column :tenant_id                                            , type: :integer
    column :printsmith_id                                            , type: :integer
    column :created_at          ,                      type: :datetime
  ...
  table :sales_summaries, force: :cascade do
    column :arbalance          ,              type: :decimal
  ...
  table :sales_summary_pickups, force: :cascade do
  ...
  table :sales_tag_by_months, force: :cascade do
    column :tenant_id                                           , type: :integer
  ...
  table :salestargets, force: :cascade do
  ...
  table :saved_reports, force: :cascade do
    column :created_at
    column :updated_at
    column :name
    column :enterprise_id                                            , type: :integer
  ...
  table :shared_users, force: :cascade do
    column :user_id                                           , type: :integer
    column :shared_id                                           , type: :integer
  end

  table :shipments, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :platform_id
    column :platform_data                                            , type: :jsonb
    column :description                                        , type: :text
  ...
  table :sms_template_categories, force: :cascade do
    column :sms_template_id                                           , type: :integer
    column :category                                            , type: :integer
  end

  table :sms_templates, force: :cascade do
    column :name                                       , type: :text
    column :body                                       , type: :text
    column :global          ,        default: false
    column :user_id          ,                       null: false                                           , type: :integer
  ...
  table :statistics, id: :bigserial, force: :cascade do
    column :company_id                                           , type: :integer
    column :tenant_id                                            , type: :integer
    column :month                                            , type: :integer
    column :year                                           , type: :integer
  ...
  table :suppressed_addresses, force: :cascade do
    column :tenant_id                                           , type: :integer
    column :email_address
    column :date
    column :reason
  ...
  table :tag_categories, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :name
  ...
  table :tag_category_contexts, force: :cascade do
    column :name
  ...
  table :taken_by_updates, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :taken_by_id                                            , type: :integer
    column :created_at
    column :updated_at
  ...
  table :taken_bys, force: :cascade do
    column :user_id                                            , type: :integer
    column :tenant_id                                            , type: :integer
    column :name
    column :created_at          ,          type: :datetime          ,                 null: false
  ...
  table :targets, force: :cascade do
    column :tenant_id                                           , type: :integer
    column :location_id                                           , type: :integer
    column :taken_by_user_id                                            , type: :integer
    column :sales_rep_user_id                                           , type: :integer
  ...
  table :task_repeats, force: :cascade do
    column :task_id                                            , type: :integer
    column :repeat_type
    column :created_at
    column :updated_at
  ...
  table :task_types, force: :cascade do
    column :name
    column :tenant_id                                           , type: :integer
    column :enterprise_id                                           , type: :integer
    column :user_id                                           , type: :integer
  ...
  table :tenants, force: :cascade do
    column :name          ,                                         limit: 255
  ...
  table :tracker_hits, force: :cascade do
    column :tracker_id                                           , type: :integer
    column :created_at          ,     type: :datetime          , null: false
    column :updated_at          ,     type: :datetime          , null: false
  ...
  table :trackers, force: :cascade do
  ...
  table :unsubscribes, force: :cascade do
    column :tenant_id                                            , type: :integer
    column :contact_id                                           , type: :integer
    column :unsub_type
    column :email
  ...
  table :workflows, force: :cascade do
    column :name
    column :company_id                                           , type: :integer
    column :user_id          ,                       null: false                                           , type: :integer
    column :global          ,        default: false
