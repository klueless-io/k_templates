def puts_red(heredoc); puts set_color heredoc, :red; end
...
puts_red "@@      @@@@@       @@@@@             @@@@"
puts_red "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
puts_red "@@@@@@@@ https://www.rubidium.io @@@@@@@@@"
puts_red "@@@@@@@@@@@@@@ 85.4678  @@@@@@@@@@@@@@@@@@"
puts_red "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
puts ""
puts ""
...
puts ""
puts ""
puts_green "Template Name: Stonerun - Tabler ready Rails template"
puts_green "By: nelson (https://www.rubidium.io/profiles/nelson)"
puts_green "https://www.rubidium.io/templates/stonerun-tabler-ready-rails-template"